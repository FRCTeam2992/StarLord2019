...
public class DriveTrain extends Subsystem {
    ...
    public DriveTrain() {
        ...
        //hatchCam = new CameraServer();

        //cargoCam = new CameraServer();
    ...
    public void SmartDriveGyro(double heading, double power){  //For PID drive with gyro
        ...
        leftTalonDrive.configPeakOutputForward(power - gkp*gyroError + gkd *pGyro);
        leftTalonDrive.configPeakOutputReverse(-power - gkp*gyroError + gkd *pGyro);
        rightTalonDrive.configPeakOutputForward(power + gkp*gyroError - gkd *pGyro);
