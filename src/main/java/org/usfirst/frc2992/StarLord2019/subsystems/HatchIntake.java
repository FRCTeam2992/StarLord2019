...
public class HatchIntake extends Subsystem {
    ...
    private Boolean hatchScoringBool = false;
    ...
    public void periodic() {
        ...
        if(!Robot.isAutoTime && !Robot.isCargoMode && hatchLoadedBool 
                && !hatchScoringBool && !Robot.VPLights && !Robot.climbLights){//hatchLoaded Lights
            Robot.hatchLoadLights = true;
            Robot.lightCode.setLightSequence(.425);
        } else if(!Robot.isAutoTime && !Robot.isCargoMode && hatchScoringBool 
                && !Robot.VPLights && !Robot.climbLights){
