...
public class Lift extends Subsystem {
    ...
    public Lift() {
        ...
        liftTalon.configClosedloopRamp(.6);// (seconds from min to full power)
        liftTalon.configClosedLoopPeakOutput(0, 0.9);
        ...
        liftTalon.config_kD(0, 2.5);
        liftTalon.config_kF(0, 0);
        liftTalon.config_IntegralZone(0, 150);
        liftTalon.configAllowableClosedloopError(0, 100, 50);// (slot, error, timeoutMs)
        */
