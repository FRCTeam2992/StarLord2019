...
/*
        if(!Robot.disabledLights && !Robot.isAutoTime && Robot.isCargoMode && cargoDistSensor.get() && !isScoring){
            Robot.cargoLoadLights = true;
            Robot.lightCode.setLightSequence(.325);
            lightScoreCounter = 0;
        } else if(!Robot.disabledLights && !Robot.isAutoTime && Robot.isCargoMode && isScoring && lightScoreCounter < 5){
            Robot.cargoScoreLights = true;
            Robot.lightCode.setLightSequence(.375);
            lightScoreCounter++;
        } else if(!Robot.disabledLights && !Robot.isAutoTime && !Robot.VPLights && Robot.isCargoMode){
...
*/
        if(!Robot.disabledLights && !Robot.isAutoTime && Robot.isCargoMode && !Robot.VPLights){
            Robot.lightCode.setLightSequence(.075);
        }
    }
