...
public class CargoIntake extends Subsystem {
    ...
    public void periodic() {
        ...
        if(!Robot.isAutoTime && Robot.isCargoMode && cargoDistSensor.get() && !isScoring){
            Robot.cargoLoadLights = true;
            Robot.lightCode.setLightSequence(.325);
            lightScoreCounter = 0;
        } else if(!Robot.isAutoTime && Robot.isCargoMode && isScoring && lightScoreCounter < 5){
            Robot.cargoScoreLights = true;
            Robot.lightCode.setLightSequence(.375);
            lightScoreCounter++;
        } else if(!Robot.isAutoTime && !Robot.VPLights){
