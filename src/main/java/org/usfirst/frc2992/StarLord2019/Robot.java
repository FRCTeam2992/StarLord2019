    ...
    public void setAutoMode() {
        ...
        switch(autoMode){
            ...
            case 1: autonomousCommand = new autoLeftSideLeftRocket();
                    ...
                    break;
            case 4: autonomousCommand = new autoMiddleToLeftCargo();
                    autoName = "Front Left Cargoship";
                    autoStartPosn = "Left-Middle Hab";
                    break;
            case 8: autonomousCommand = new autoMiddleToRightCargo();
                    autoName = "Front Right Cargoship";
                    autoStartPosn = "Right-Middle Hab";
                    break;
            case 16: autonomousCommand = new AutoRightRocketRightSide();
