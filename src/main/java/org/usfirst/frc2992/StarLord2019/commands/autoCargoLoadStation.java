...
public class autoCargoLoadStation extends CommandGroup {
  ...
  public autoCargoLoadStation() {
    ...
    addParallel(new LiftSetHeight(1, Constants.normalLiftUpSpeed, Constants.normalLiftDownSpeed, 2));
    ...
    addParallel(new LiftSetHeight(0, 0.4, Constants.normalLiftDownSpeed, 4));//why was this changed - we're not going up here
    addSequential(new WaitCommand(0.5));
    addSequential(new CargoDeploySol(false));
    addSequential(new CargoIntakeFeedStop());
  }
}
