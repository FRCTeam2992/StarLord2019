 ...
 *
 */
public class VisionProcessingBetter extends Command {
...
//From Limelight Ex
    ...
    private double gyroAngle = Robot.driveTrain.navx.getYaw();
...
*/
    ...
    public void enhancedDriving(){
        ...
        gyroAngle = Robot.driveTrain.navx.getYaw();
        double nearest45 = (int)Math.round((gyroAngle + TX) / 45.0) * 45.0;
        double gError = nearest45 - gyroAngle;
        double steerError = TX + gError;
        ...
        if(TV < 1.0){
            ...
            //start with proportional steering
            double steerCmd = steerError * STEER_K;
            m_turnCmd = steerCmd;
