...
public class AutoDriveFwd extends Command {
    ...
    private int m_Distance; //must be int bc math in drivetrain has to be int for encoder ticks
    ...
    public AutoDriveFwd(int Distance, double Speed, double TimeOut, boolean Gyro, double Heading) {
