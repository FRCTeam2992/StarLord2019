...
public class AutoDriveFwd extends Command {
    ...
    protected void initialize() {
        ...
        timer.reset();
        timer.start();
        rEncVal = Robot.driveTrain.rightTalonDrive.getSelectedSensorPosition();
        lEncVal = Robot.driveTrain.leftTalonDrive.getSelectedSensorPosition();
        //SET DISTANCE
    ...
    protected void execute() {
        ...
        isDoneRight = Math.abs(Robot.driveTrain.convertEncoderTicks(m_Distance) + rEncVal - Robot.driveTrain.rightTalonDrive.getSelectedSensorPosition()) < Robot.driveTrain.convertEncoderTicks(1);
        isDoneLeft = Math.abs(Robot.driveTrain.convertEncoderTicks(m_Distance) + lEncVal - Robot.driveTrain.leftTalonDrive.getSelectedSensorPosition()) < Robot.driveTrain.convertEncoderTicks(1);
        //encoders reset in initialize
       if(m_Gyro) {
           //SET HEADING AND SPEED
           Robot.driveTrain.SmartDriveGyro(m_Heading, m_Speed, m_Distance);
       } 
    }
