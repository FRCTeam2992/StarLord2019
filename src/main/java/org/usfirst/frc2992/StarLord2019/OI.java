...
public class OI {
    ...
    public OI() {
        ...
        gearShiftBtn = new JoystickButton(rightJoy, 1);
        gearShiftBtn.whileHeld(new Robot.driveTrain.);
        ...
        hatchExtendBtn = new JoystickButton(rightJoy, 1);
        ...
        SmartDashboard.putData("ExtendArms", new ExtendArms(true));
