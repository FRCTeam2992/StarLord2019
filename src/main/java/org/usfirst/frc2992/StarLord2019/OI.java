...
public class OI {
    ...
    boolean isCargoMode = GlobalVariables.isCargoMode;
    ...
    public OI() {
        ...
        liftSetMiddleRocket.whenPressed(isCargoMode? new LiftSetHeight(Constants.middleRocketCargoHeight, 2): new LiftSetHeight(Constants.middleRocketHatchHeight, 2));
        ...
        liftSetBottomRocket.whenPressed(isCargoMode? new LiftSetHeight(Constants.bottomRocketCargoHeight, 2): new LiftSetHeight(Constants.bottomRocketHatchHeight, 2));
        ...
        liftDownBtn = new JoystickButton(rightJoy, 9);
